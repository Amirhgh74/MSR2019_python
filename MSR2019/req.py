import requests
origin = """ public static LicenceNumber getInstance(Name driverName, Date issueDate){
...
edit = "dddddddddddddddddddddddddddddddddddddd"

r = requests.post("http://127.0.0.1:8000/quuu/", json={'origin': origin, 'edit': edit})
